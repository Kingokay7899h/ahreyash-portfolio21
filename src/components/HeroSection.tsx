  ...
  return (
    <div className="relative">
      ...
      <section className="relative h-screen overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              ...
              >
                ...
                <span className="bg-gradient-to-r from-accent to-tech-blue bg-clip-text text-transparent">creativity</span> and{' '}
                <span className="bg-gradient-to-r from-accent to-tech-blue bg-clip-text text-transparent">functionality</span>
              </motion.p>
        ...
        {/* Parallax Grid */}
        <div 
          className="absolute inset-0 opacity-20 bg-tech-grid bg-grid"
          style={{
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-section font-bold text-center mb-16">
              The <span className="bg-gradient-to-r from-accent to-tech-blue bg-clip-text text-transparent">Journey</span>
            </h2>
